...
def setup_schools(args, net: sumolib.net.Net, stats: ET.ElementTree, school_count: int or None,
    ...
    school_open_earliest = int(args["--primary-schools.open"].split(",")[0]) * 3600
    school_open_latest = int(args["--primary-schools.open"].split(",")[1]) * 3600
    school_close_earliest = int(args["--primary-schools.close"].split(",")[0]) * 3600
    school_close_latest = int(args["--primary-schools.close"].split(",")[1]) * 3600
    school_stepsize = int((float(args["--primary-schools.stepsize"]) * 3600))
