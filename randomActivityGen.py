"""Usage: randomActivityGen.py --net-file=FILE --stat-file=FILE --output-file=FILE [--centre.pos=args]
    ...
    [--schools.close=args]  [--primary-schools.begin-age=args] [--primary-schools.end-age=args] [--primary-schools.count=N]
    [--primary-schools.ratio=F] [--primary-schools.capacity=args] [--high-schools.begin-age=args]
    [--high-schools.end-age=args] [--high-schools.count=N] [--high-schools.ratio=F] [--high-schools.capacity=args]
    [--colleges.begin-age=args] [--colleges.end-age=args] [--colleges.count=N] [--colleges.ratio=F]
    [--colleges.capacity=args] [--bus-stop.distance=N] [--bus-stop.k=N] [--display] [--display.size=N]
...
Other Options:
    ...
    --primary-schools.end-age=args      The range of ages at which students stops going to school [default: 12,16]
    --primary-schools.capacity=args     The range for capacity in schools [default: 100,500]
    --high-schools.count N           Number of schools in the city, if not used, number of schools is based on population [default: auto]
    --high-schools.ratio F           Number of schools per 1000 inhabitants [default: 0.04]
    --high-schools.begin-age=args    The range of ages at which students start going to school [default: 15,18]
    --high-schools.end-age=args      The range of ages at which students stops going to school [default: 18,23]
    --high-schools.capacity=args     The range for capacity in schools [default: 600,1000]
    --colleges.count N           Number of schools in the city, if not used, number of schools is based on population [default: auto]
    --colleges.ratio F           Number of schools per 1000 inhabitants [default: 0.015]
    --colleges.begin-age=args    The range of ages at which students start going to school [default: 19,25]
    --colleges.end-age=args      The range of ages at which students stops going to school [default: 24,29]
    --colleges.capacity=args     The range for capacity in schools [default: 1000,2000]
